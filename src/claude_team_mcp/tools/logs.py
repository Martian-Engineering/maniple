"""
Worker log reading and examination tools.

Provides read_worker_logs, examine_worker, and annotate_worker for
inspecting worker conversation history and status.
"""
...
def register_tools(mcp: FastMCP) -> None:
    """Register log reading and examination tools on the MCP server."""
