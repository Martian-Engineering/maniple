...
# Install launchd service for claude-team HTTP mode.

script_dir="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd -P)"
repo_root="$(cd "${script_dir}/.." && pwd -P)"
launch_agents_dir="${HOME}/Library/LaunchAgents"
plist_path="${launch_agents_dir}/com.claude-team.plist"
logs_dir="${HOME}/.claude-team/logs"
stdout_log="${logs_dir}/claude-team.out.log"
stderr_log="${logs_dir}/claude-team.err.log"
index_cron="${CLAUDE_TEAM_INDEX_CRON:-1h}"
